...
func (h *SettingsHandler) GetWebInfo(c *gin.Context) {
	// 只获取前台展示用的公共配置项
	allowKeys := []string{
...
func (h *SettingsHandler) GetImagePrefix(c *gin.Context) {
	cfg := config.Get()
...
func (h *SettingsHandler) GetAvatarPrefix(c *gin.Context) {
	cfg := config.Get()
	c.JSON(http.StatusOK, gin.H{
...
func (h *SettingsHandler) GetDefaultStorageQuota(c *gin.Context) {
	c.JSON(http.StatusOK, gin.H{
